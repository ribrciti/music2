...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { description: @band.description, name: @band.name, user_id: @band.user_id } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { description: @band.description, name: @band.name, user_id: @band.user_id } }
